...
public class Kontrolleri implements IKontrolleri { // UUSI
	...
	private int lukuRuuhkaNormaali = 25;
	private int lukuRuuhkaVahan = 40;
	...
	/**
	 * Kaynnistaa simuloinnin valitulla simulaatioajalle ja viiveella
	 * seka visualisoi valitun maaran turvatarkastuspisteita
	 */
	@Override
	...
	/**
	 * Hidastaa simulaattorin toimintaa
	 */
	@Override
	...
	/**
	 * Nopeuttaa simulaattorin toimintaa
	 */
	@Override
	...
	/**
	 * Asettaa viiveen nollaksi eli simulointi etenee mahdollisimman nopeasti
	 */
	@Override
	public void skippaa() {
		moottori.setViive(0);
	...
	/**
	 * Nayttaa viiveen visualisoinnissa
	 */
	...
	/**
	 * Kirjoittaa visualisointiin simuloinnin lopullisen kokonaisajan
	 * 
	 * @param ajoId minka ajon tiedot haetaan
	 */
	@Override
	...
	/**
	 * Kirjoittaa visualisointiin simuloinnin lopullisen kokonaisasiakasmaaran
	 * 
	 * @param ajoId minka ajon tiedot haetaan
	 */
	@Override
	...
	/**
	 * Hakee kayttajan maarittamat ahkeruusarvot UIsta ja asettaa ne moottorissa kayttoon
	 */
	@Override
	...
	/**
	 * Asettaa uudet keskijakaumat saapumis tapahtumille, perustuen simulaattorin
	...
	/**
	 * Asettaa halutun maaran turvatarkastuspisteita kayttoon kayttajan UIn valinnan mukaan 
	 */
	@Override
	...
	/**
	 * Muuntaa vetovalikon indeksi arvon vastaamaan sopivaa lukua kaytettavaksi
	 ...
	 * kaikkien palvelupisteiden lapimenoajat ja annetaan ne parametrina GUI:lle
	 * 
...
//double laukut, double t1, double t2, double t3, double t4, double t5, double check, double erityis
	...
	/**
	 * Haetaan tietokannasta halutun ajokerran tulos-olio. Haetaan tulos-oliosta
	 * kaikkien palvelupisteiden keskimaaraiset jononpituudet ja annetaan ne
	 * parametrina GUI:lle
	 * 
	 * @param ajoId Tietokannasta haettavan ajokerran tuloksien id
	 */
	...
	/**
	 * Hakee ajossa kaytetyt parametrit ja nayttaa ne tuloksien visualisoinnissa
	 * 
	 * @param ajoId minka ajon tiedot haetaan
	 */
	...
	/**
	 * Lisaa ajokerta listan uuteen listaan ja ottaa listan viimeisessä indeksissa
	...
	/**
	 * Asettaa skippaa loppuun napin kaytettavaksi
	 */
